<?php
/*
 * DokuWiki Mozilla Community Template
 *
...
<head>
  ...
  <?php tpl_metaheaders()?>
  <link href="<?php echo DOKU_TPL?>/design.css" rel="stylesheet" />
...
<div class="mozilla_tback"><div class="mozilla_bback">
...
<div class="dokuwiki">
  ...
  <div class="stylehead">
	...
	<div class="mozilla_header">
		<a href="http://www.mozilla.com"><span>Mozilla Website Community</span></a>
		<?php tpl_searchform()?>
	</div>
...
<div style="font-size:6pt">mozfr</div>
